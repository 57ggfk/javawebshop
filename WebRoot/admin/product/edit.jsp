...
<body>
	...
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/adminProduct_edit.action?pid=${p.pid}"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="pname" value="${p.pname }" id="userAction_save_do_logonName"
					class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					是否热门：</td>
				<td class="ta_01" bgColor="#ffffff"><select name="is_hot">
						<option value="1" ${p.is_hot>0?"selected":""}>是</option>
						<option value="0" ${p.is_hot==0?"selected":""}>否</option>
				</select></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					市场价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="market_price" value="${p.market_price }"
					id="userAction_save_do_logonName" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					商城价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="shop_price" value="${p.shop_price }"
					id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><select
					name="cid">
						<c:forEach items="${categories }" var="c">
							<option value="${c.cid }" ${c.cid==p.cid?"selected":"" }>${c.cname }</option>
						</c:forEach>
				</select></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><textarea
						name="pdesc" rows="10" cols="80">${p.pdesc }</textarea></td>
			</tr>
			<tr>
