...
<body>
	...
	<table width="100%" border="0">
		...
		d.add('010201','0102','分类管理','${pageContext.request.contextPath}/admin/category/categoryFindAll','','mainFrame');
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/admin/product/productFindAll','','mainFrame');
		document.write(d);
