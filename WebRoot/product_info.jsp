...
<script type="text/javascript">
	...
	function cartAdd() {
		...
		//alert(num);
		window.location.href = "${pageContext.request.contextPath}/cartAdd?pid=${p.pid}&num="+num;
	}
	
	function count() {
		<%-- 当用户修改商品数量时，计算小计和商品金额 --%>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index.htm">首页&nbsp;&nbsp;&gt;</a> <a href="./蔬菜分类.htm">手机&nbsp;&nbsp;&gt;</a>
				<a>手机数码</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${p.shop_price }元/份</strong>
						参 考 价：
					...
					<div
						...
						<div
							...
							购买数量: <input id="quantity" name="quantity" value="1"
								maxlength="4" size="10" type="text" onchange="countMoney()">
						</div>

						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:void(0);" onclick="cartAdd()"> <input
